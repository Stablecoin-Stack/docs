...
A *service provider* in this context is a registered acquirer who has opted in to having their data included in the public registry maintained by **basic-data-server**. By making provider selection a first-class user choice, the reference wallet embodies the open and non-exclusive nature of the acquiring model described in [SSF-SPEC-001](../01-instant-payment-with-permitted-token-transfer-submission/01-instant-payment-with-permitted-token-transfer-submission.md).